...
[Service]
User=roboshop
Environment=CART_ENDPOINT=cart.app-dev.hiteshshop.online:80
Environment=DB_HOST=mysql-dev.hiteshshop.online
...
# Load Schema
mysql -h mysql-dev.hiteshshop.online -uroot -pRoboShop@1 < /app/schema/shipping.sql
